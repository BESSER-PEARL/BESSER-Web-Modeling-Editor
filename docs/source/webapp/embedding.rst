...
``packages/webapp2/src/main/components/apollon-editor-component/ApollonEditorComponent.tsx``
...
2. Mount the ``ApplicationStore`` provider (``store/application-store``)
...
.. code-block:: tsx
   ...
   import { ApplicationStore } from 'packages/webapp2/src/main/store/application-store';
   import { ApollonEditorComponent } from 'packages/webapp2/src/main/components/apollon-editor-component/ApollonEditorComponent';
