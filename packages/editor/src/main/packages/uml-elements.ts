...
export const UMLElements = {
  ...
  [NNElementType.PermuteInAttributeEmbedding]: PermuteInAttributeEmbedding,
  [NNElementType.PermuteOutAttributeEmbedding]: PermuteOutAttributeEmbedding,
  ...
  [NNElementType.PermuteInAttributeDropout]: PermuteInAttributeDropout,
  [NNElementType.PermuteOutAttributeDropout]: PermuteOutAttributeDropout,
