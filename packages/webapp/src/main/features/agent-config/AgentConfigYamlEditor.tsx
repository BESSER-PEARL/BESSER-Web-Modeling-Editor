        ...
        <div className="space-y-3">
          ...
          <Section title="NLP" defaultOpen>
            ...
            <Section title="Mistral AI" defaultOpen={false} indent>
              <TextField id="nlp-mistral-key" label="api_key" value={form.nlp.mistral_api_key} onChange={v => setNlp({ mistral_api_key: v })} description="Mistral AI API key for model access." />
            </Section>
            <Section title="DeepSeek" defaultOpen={false} indent>
              <TextField id="nlp-deepseek-key" label="api_key" value={form.nlp.deepseek_api_key} onChange={v => setNlp({ deepseek_api_key: v })} description="DeepSeek API key for model access." />
            </Section>
            <Section title="Google (Gemini)" defaultOpen={false} indent>
              <TextField id="nlp-google-key" label="api_key" value={form.nlp.google_api_key} onChange={v => setNlp({ google_api_key: v })} description="Google AI (Gemini) API key for model access." />
            </Section>
            <Section title="Meta (Llama)" defaultOpen={false} indent>
              <TextField id="nlp-meta-key" label="api_key" value={form.nlp.meta_api_key} onChange={v => setNlp({ meta_api_key: v })} description="Meta AI API key for Llama model access." />
            </Section>
            <Section title="Anthropic (Claude)" defaultOpen={false} indent>
              <TextField id="nlp-anthropic-key" label="api_key" value={form.nlp.anthropic_api_key} onChange={v => setNlp({ anthropic_api_key: v })} description="Anthropic API key for Claude model access." />
            </Section>
            <Section title="Alibaba Qwen" defaultOpen={false} indent>
              <TextField id="nlp-qwen-key" label="api_key" value={form.nlp.qwen_api_key} onChange={v => setNlp({ qwen_api_key: v })} description="Alibaba DashScope API key for Qwen model access." />
            </Section>
            <Section title="xAI (Grok)" defaultOpen={false} indent>
              <TextField id="nlp-xai-key" label="api_key" value={form.nlp.xai_api_key} onChange={v => setNlp({ xai_api_key: v })} description="xAI API key for Grok model access." />
            </Section>
            <Section title="Groq" defaultOpen={false} indent>
              <TextField id="nlp-groq-key" label="api_key" value={form.nlp.groq_api_key} onChange={v => setNlp({ groq_api_key: v })} description="Groq API key for fast inference." />
            </Section>
            <Section title="Together AI" defaultOpen={false} indent>
              <TextField id="nlp-together-key" label="api_key" value={form.nlp.together_api_key} onChange={v => setNlp({ together_api_key: v })} description="Together AI API key for hosted model access." />
            </Section>
            <Section title="OpenRouter" defaultOpen={false} indent>
              <TextField id="nlp-openrouter-key" label="api_key" value={form.nlp.openrouter_api_key} onChange={v => setNlp({ openrouter_api_key: v })} description="OpenRouter API key for accessing models from many providers." />
            </Section>
