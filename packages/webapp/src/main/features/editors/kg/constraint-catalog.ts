...
export const CONSTRAINT_CATALOG: ConstraintCatalogEntry[] = [
  ...
  // --- Value (PC) ----------------------------------------------------------
  {
    ...
    description:
      'At least one value must be an instance of the chosen class. OWL-only — SHACL has no ' +
      'faithful existential predicate (sh:class means "every value", not "some value").',
    category: 'value',
    vocab: ['owl'],
  ...
  {
    kind: 'equals',
    label: 'Equal to property',
    description: "This property's value set must exactly match another property's value set.",
    category: 'value',
    vocab: ['shacl'],
    valueShape: 'property-iri',
    applicableTo: PC,
    shaclTerm: 'sh:equals',
  },
  {
    kind: 'lessThan',
    label: 'Less than property',
    description: 'Each value must be strictly less than the corresponding value of another property.',
    category: 'value',
    vocab: ['shacl'],
    valueShape: 'property-iri',
    applicableTo: PC,
    hiddenWhen: { targetPropertyKind: 'Object' },
    shaclTerm: 'sh:lessThan',
  },
  {
    kind: 'lessThanOrEquals',
    label: 'Less than or equal to property',
    description: 'Each value must be less than or equal to the corresponding value of another property.',
    category: 'value',
    vocab: ['shacl'],
    valueShape: 'property-iri',
    applicableTo: PC,
    hiddenWhen: { targetPropertyKind: 'Object' },
    shaclTerm: 'sh:lessThanOrEquals',
  },
