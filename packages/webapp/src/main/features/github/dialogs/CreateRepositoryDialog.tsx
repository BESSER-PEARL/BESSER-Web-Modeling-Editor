    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-xl">
        ...
        <div className="flex flex-col gap-4">
          ...
          <FormField label={t('github.createRepo.descriptionLabel')}>
            <Textarea
              rows={2}
          ...
          <FormField label={t('github.folderPathLabel')}>
            <Input
          ...
          <FormField label={t('github.fileNameLabel')} required error={validation.getError('fileName')}>
            <Input
