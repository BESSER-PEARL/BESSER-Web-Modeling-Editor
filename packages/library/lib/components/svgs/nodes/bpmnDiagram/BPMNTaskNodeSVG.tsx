...
export const BPMNTaskNodeSVG: React.FC<BPMNTaskNodeSVGProps> = ({
  ...
  const icon = (() => {
    switch (taskType) {
      ...
      case "service":
        // BPMN 2.0.2 §10.2.3.1 gear glyph — path ported from develop's
        // BPMNServiceIcon (8-tooth gear outline + hub circle).
        return (
          <g transform={`translate(10,10)`}>
            <path
              d="M 7.47 3.9 L 8.44 1.14 L 11.56 1.14 L 12.53 3.9 L 15.16 2.63 L 17.37 4.84 L 16.1 7.47 L 18.86 8.44 L 18.86 11.56 L 16.1 12.53 L 17.37 15.16 L 15.16 17.37 L 12.53 16.1 L 11.56 18.86 L 8.44 18.86 L 7.47 16.1 L 4.84 17.37 L 2.63 15.16 L 3.9 12.53 L 1.14 11.56 L 1.14 8.44 L 3.9 7.47 L 2.63 4.84 L 4.84 2.63 Z"
              fill="none"
              stroke={strokeColor}
              strokeWidth={LAYOUT.ICON_LINE_WIDTH}
